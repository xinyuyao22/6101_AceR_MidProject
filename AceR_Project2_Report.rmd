...
#### 2.5.2 Is that bmi affect cardiovascular disease?
...
#### 2.5.3 Basic analysis of BMIgroup
...
#### 2.6.2 Are systolic blood pressure the same across all age group?
...
#### 2.6.3 Are diastolic blood pressure the same across all age group?
...
## Chapter 3: Model building and evaulation 
...
#### 3.3.1 Preparation: Standardize the numerical variables
...
### 3.4 KNN
#### 3.4.1 Preprocessing and fitting the model

```{r 9.1, echo=F}
loadPkg("FNN")
#cardioKnn <- subset(cardio, select = -c(gender, cholesterol, gluc, smoke, alco, active, height, weight, prob, cardio))
cardioKnn <- subset(cardio, select = -c(gender, cholesterol, gluc, smoke, alco, active, height, weight, prob, cardio,bmiGroup,ageGroup))
